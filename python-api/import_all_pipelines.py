...
def main():
    ...
    print(f"🚀 Found {len(json_files)} Pipeline file(s) to import.")
    
    script_path = os.path.join(os.path.dirname(__file__), "import_pipelines.py")
