...
def main():
    ...
    target_dir = os.path.join(json_dir_base, "databaseService")
    ...
    print(f"🚀 Found {len(json_files)} Database Service(s) to import.")
    
    script_path = os.path.join(os.path.dirname(__file__), "import_db_service.py")
    ...
    print("\n✅ Bulk Database Service import complete.")
