...
def main():
    ...
    target_dir = os.path.join(json_dir_base, "searchService")
    ...
    print(f"🚀 Found {len(json_files)} Search Service(s) to import.")
    
    script_path = os.path.join(os.path.dirname(__file__), "import_search_service.py")
    ...
    print("\n✅ Bulk Search Service import complete.")
